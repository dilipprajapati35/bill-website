    ...
    <footer className="bg-button text-white">
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
          <div>
            <h3 className="text-xl font-bold mb-4 text-secondary">GR Billing</h3>
            <p className="text-gray-300">Simplifying your business, one transaction at a time.</p>
          </div>
          <div>
        ...
        <div className="mt-12 border-t border-gray-700 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} GR Billing. All Rights Reserved.</p>
        </div>
      </div>
    </footer>
  );
