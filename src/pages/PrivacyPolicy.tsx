      ...
      <div className="container mx-auto px-6">
        <div className="prose lg:prose-xl max-w-4xl mx-auto">
          ...
          <p className="lead">
            ...
            you across our website and our mobile application, GR Billing.
          </p>
          ...
          <p>
            To provide the full functionality of the GR Billing mobile app, we
            require certain permissions on your device. Here is a breakdown of
            why we need them:
          </p>
          <ul>
            <li>
              <strong>Internet:</strong> The app requires an internet connection
              to sync your data across devices, process transactions, back up
              your information securely, and communicate with our servers.
            </li>
            <li>
              <strong>Camera:</strong> We request camera access to enable you to
              scan product barcodes and QR codes. This feature significantly
              speeds up the billing process and inventory management.
            </li>
            <li>
              <strong>
                Storage (Read External Storage / Read Media Images):
              </strong>{" "}
              This permission is needed to allow you to upload images for your
              products directly from your device's gallery.
            </li>
            <li>
              <strong>
              ...
              These permissions are essential for the wireless printing feature.
              They allow the app to discover, pair with, and connect to
              compatible Bluetooth receipt printers.
            </li>
            <li>
              <strong>
                Location (ACCESS_FINE_LOCATION, ACCESS_COARSE_LOCATION):
              </strong>{" "}
              Modern versions of Android require location permission to scan for
              nearby Bluetooth devices like wireless printers. We want to assure
              you that we do not track, store, or use your location data for any
              other purpose. This permission is solely to enable the discovery
          ...
          <ul>
            ...
            <li>
              ...
              updates and other information, and for marketing and promotional
              purposes
            </li>
          ...
          <p>
            By using our website and/or mobile app, you hereby consent to our
            Privacy Policy and agree to its terms.
          </p>
          <h2>7. Account & Data Deletion Request</h2>
          <p>
            If you want to request deletion of your account and all associated
