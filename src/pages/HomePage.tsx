...
const FloatingContactButton: React.FC = () => {
  ...
  const [activeMenu, setActiveMenu] = React.useState<'main' | 'call' | 'whatsapp'>('main');
  const ayushiPhone = '919783008107';
  const dilipPhone = '919694031292';
  const waLinkAyushi = `https://wa.me/${ayushiPhone}?text=${encodeURIComponent('Hello! I need help with GR Billing')}`;
  const waLinkDilip = `https://wa.me/${dilipPhone}?text=${encodeURIComponent('Hello! I need help with GR Billing')}`;
  ...
  return (
    <div className="fixed bottom-8 right-8 z-50">
      <div
        ...
        onMouseLeave={() => { setIsOpen(false); setActiveMenu('main'); }}
      >
        {/* Dropdown Menu */}
        <div
        ...
        >
          <div className="flex flex-col items-stretch space-y-2">
            {activeMenu === 'main' && (
              <>
                ...
                <button
                  ...
                  className="bg-white hover:bg-gray-50 text-gray-800 px-5 py-3 rounded-full shadow-lg hover:shadow-xl flex items-center space-x-3 transition-all duration-200 transform hover:scale-105 min-w-[160px] text-left"
                >
                  ...
                  <span className="font-medium text-sm flex-1">Call Us</span>
                ...
                >
                  ...
                  <span className="font-medium text-sm flex-1">WhatsApp</span>
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-gray-400" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clipRule="evenodd" />
                  </svg>
                </button>
            ...
            {activeMenu === 'call' && (
              <>
                <button
                  onClick={(e) => { e.stopPropagation(); setActiveMenu('main'); }}
                  className="bg-gray-100 hover:bg-gray-200 text-gray-800 px-5 py-2 rounded-full flex items-center space-x-2 transition-all duration-200 min-w-[160px] mb-2"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M12.707 5.293a1 1 0 010 1.414L9.414 10l3.293 3.293a1 1 0 01-1.414 1.414l-4-4a1 1 0 010-1.414l4-4a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  <span className="font-medium text-xs text-gray-600">Back</span>
                </button>
                {/* Call Ayushi */}
                <a
                  href={`tel:+${ayushiPhone}`}
                  className="bg-white hover:bg-gray-50 text-gray-800 px-5 py-3 rounded-full shadow-lg hover:shadow-xl flex items-center space-x-3 transition-all duration-200 transform hover:scale-105 min-w-[160px]"
                >
                  ...
                  <span className="font-medium text-sm">Ayushi</span>
                </a>
                {/* Call Dilip */}
                <a
                  href={`tel:+${dilipPhone}`}
                ...
                >
                  ...
                  <span className="font-medium text-sm">Dilip</span>
                </a>
              </>
            )}
